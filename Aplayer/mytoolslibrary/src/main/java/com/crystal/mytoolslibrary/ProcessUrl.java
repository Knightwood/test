...
import com.crystal.fucktoollibrary.tools.preferences.PreferenceTools;
...
public class ProcessUrl {
    ...
    public ProcessUrl(Context context) {
        ...
        engine = PreferenceTools.getString(context, SomeRes.searchengine, "https://mijisou.com/search?q=");
