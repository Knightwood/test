...
public class DownloadWindow extends DialogFragment {
    ...
    private void setInfo(){
        ...
        TextView title=this.downloadWindow.findViewById(R.id.downloadTtitle);
        TextView url=this.downloadWindow.findViewById(R.id.downloadUrl);

        title.setText(mDownloadInfo.getFileName());
        url.setText(mDownloadInfo.getUrl());
    }
}
