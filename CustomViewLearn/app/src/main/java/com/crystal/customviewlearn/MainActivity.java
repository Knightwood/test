...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animatorlayout1);
        //写个方法动态注册广播
        registerBroadcastRecycler();
        bindViews();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_four:
                ...
                break;
            case R.id.img_babi:
                Toast.makeText(MainActivity.this, "不愧是", Toast.LENGTH_SHORT).show();
                break;
        }
    }
...
//        vValue.start();
    ...
    private void raAnimator(){
        ...
        rValue.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float fractionValue=animation.getAnimatedFraction();//获取动画进行的百分比
    ...
    private void registerBroadcastRecycler() {
        myReceiver = new MyBRReceiver();
        IntentFilter filter = new IntentFilter();
        filter.addAction("android.net.conn.CONNECTIVITY_CHANGE");//intent添加行为
    ...
    protected void onDestroy() {
        super.onDestroy();
        unregisterReceiver(myReceiver);//取消注册广播
    }
}
